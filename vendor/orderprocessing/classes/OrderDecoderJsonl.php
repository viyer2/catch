    ...
    class OrderDecoderJsonl
    {
        ...
        protected function calculateOrderData()
        {
            ...
            if ($this->jsonObj->{'items'}) {
                ...
                $this->itemCounts['TOTALS']['TOTAL_VALUE'] = number_format($this->itemCounts[$this->orderId]['TOTALS']['TOTAL_VALUE'],2);
                $this->setReturnFields('total_order_value', $this->itemCounts[$this->orderId]['TOTALS']['TOTAL_VALUE']);
            } else {
                $this->drop = 1;
